...
version = 'v3.4b'  # Simple identifier, has no other function than being appended to the end of the output filename
...
if 'seedfile' in locals():
    ...
    ycoords = np.arange(coord_mm[2] + seedspacing / 2 + 1, coord_mm[3] - seedspacing / 2 - 1, seedspacing)
